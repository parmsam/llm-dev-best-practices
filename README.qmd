...
- As you make updates to your system prompt tools, and other LLM parameters, you should not manually check the performance of your LLM-based applications. Instead, use an evaluation framework to automate this process.
    - If you're using R, I recommend the [`vitals`](https://vitals.tidyverse.org/index.html) package and if you use Python, I recommend the [`Inspect`](https://inspect.aisi.org.uk/) library.
